...
router.post("/", authToken, todoController.createTask);
router.get("/", authToken, todoController.getAllTasks);
router.get("/:taskId", authToken, todoController.getTaskById);
router.put("/:taskId", authToken, todoController.updateTaskById);
router.delete("/deleteall", todoController.deleteAllTasks);
router.delete("/:taskId", todoController.deleteTaskById);
router.get("/filter/:status", authToken, todoController.filterTasksByStatus);
